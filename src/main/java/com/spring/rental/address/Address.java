...
public class Address {
    ...
    @JsonIgnore
    @OneToMany(mappedBy = "renterAddress", cascade = {CascadeType.PERSIST, CascadeType.REMOVE})
    private List<Rental> rentalsAsRenterAddress;

    @JsonIgnore
    @OneToMany(mappedBy = "renteeAddress", cascade = {CascadeType.PERSIST, CascadeType.REMOVE})
